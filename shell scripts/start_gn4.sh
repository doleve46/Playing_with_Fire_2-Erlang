...
export GN_ID=gn4
export NODE_NAME="GN4@$IP_ADDRESS"
...
echo "Starting Erlang shell with name GN4@$IP_ADDRESS..."
...
(sleep 1.5; cat /tmp/erlang_commands.txt; cat) | rebar3 shell --name "GN4@$IP_ADDRESS" --setcookie 12345
